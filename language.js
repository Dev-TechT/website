(() => {
    ...
    const content = [
        ...
        { selector: "#work .work-card:nth-child(2) h3", en: "Mission Control operator dashboard", de: "Mission-Control-Operator-Dashboard" },
        { selector: "#work .work-card:nth-child(2) p:nth-of-type(1)", en: "Built a local operator dashboard for automation work: task state, service health, evidence links and approval points in one client-safe snapshot. Raw infrastructure details stay out of the public view.", de: "Lokales Operator-Dashboard für Automatisierungsarbeit gebaut: Aufgabenstatus, Service-Health, Evidence-Links und Freigabepunkte in einem kundensicheren Snapshot. Rohe Infrastrukturdetails bleiben aus der öffentlichen Ansicht heraus." },
        { selector: "#work .work-card:nth-child(2) .work-tags", en: "operations · evidence · approvals · client-safe view", de: "Betrieb · Evidence · Freigaben · kundensichere Ansicht" },
        { selector: "#work .work-card:nth-child(3) h3", en: "Agent runtime and repo reliability", de: "Agent-Runtime- und Repo-Zuverlässigkeit" },
        { selector: "#work .work-card:nth-child(3) p:nth-of-type(1)", en: "Hardened agent-assisted repository work with scoped fixes, local and CI checks, passive repo watchlists, fallback checks and quiet no-news monitoring before calling work complete.", de: "Agent-gestützte Repository-Arbeit mit abgegrenzten Fixes, lokalen und CI-Checks, passiven Repo-Watchlists, Fallback-Checks und stillem No-News-Monitoring gehärtet, bevor Arbeit als abgeschlossen gilt." },
        { selector: "#work .work-card:nth-child(3) .work-tags", en: "GitHub · CI · watchdogs · safe automation", de: "GitHub · CI · Watchdogs · sichere Automatisierung" },
