(() => {
    ...
    const content = [
        ...
        { selector: "#work .work-card:nth-child(2) h3", en: "Multilingual AI consistency check", de: "Mehrsprachiger KI-Konsistenzcheck" },
        { selector: "#work .work-card:nth-child(2) p:nth-of-type(1)", html: true, en: "Built a <a href=\"ai-language-check.html\">public demo</a> for checking when the same AI task answers differently across languages. It uses fictional sample data, clear caveats and no model rankings.", de: "Öffentliche <a href=\"ai-language-check.html\">Demo</a> gebaut, um zu prüfen, wann dieselbe KI-Aufgabe je nach Sprache anders antwortet. Sie nutzt fiktive Beispieldaten, klare Hinweise und keine Modell-Rankings." },
        ...
        { selector: "#work .work-list article:nth-child(16) p", en: "Hardened agent-assisted repository work with scoped fixes, local and CI checks, durable review queues and quiet no-news monitoring.", de: "Agent-gestützte Repository-Arbeit mit abgegrenzten Fixes, lokalen und CI-Checks, belastbaren Review-Queues und stillem No-News-Monitoring gehärtet." },
