(() => {
    ...
    const content = [
        ...
        { selector: "#work .work-card:nth-child(2) h3", en: "CAD workflow hardening", de: "CAD-Workflow-Härtung" },
        ...
        { selector: "#work .work-list article:nth-child(10) p", en: "Operate a private Linux homelab with self-hosted collaboration, search, automation and local AI services, backed by health checks for uptime, disk, memory and web endpoints.", de: "Privates Linux-Homelab mit selbst gehosteter Zusammenarbeit, Suche, Automatisierung und lokalen AI-Diensten betrieben, abgesichert durch Health Checks für Uptime, Disk, Memory und Web-Endpunkte." },
        ...
        { selector: "#work .work-list article:nth-child(12) h3", en: "Agent workflow hardening", de: "Agent-Workflow-Härtung" },
        { selector: "#work .work-list article:nth-child(12) p", en: "Turned loose agent runs into safer workflows with checks, logs, clearer handoffs and review points before anything important changes.", de: "Lose Agent-Läufe in sicherere Workflows überführt, mit Checks, Logs, klareren Übergaben und Review-Punkten, bevor etwas Wichtiges geändert wird." },
        { selector: "#work .work-list article:nth-child(13) h3", en: "Agent-assisted idea scoring", de: "Agent-gestütztes Idea Scoring" },
        { selector: "#work .work-list article:nth-child(13) p", en: "Built a lightweight scoring flow to compare commercial ideas by market signal, effort, risk and personal fit before investing more time.", de: "Leichten Scoring-Flow gebaut, um kommerzielle Ideen nach Marktsignal, Aufwand, Risiko und persönlichem Fit zu vergleichen, bevor mehr Zeit investiert wird." },
        { selector: "#work .work-list article:nth-child(14) h3", en: "Paid repo maintenance workflow", de: "Paid-Repo-Maintenance-Workflow" },
        { selector: "#work .work-list article:nth-child(14) p", en: "Tested a workflow for finding real maintenance work, checking buyer signals, preparing fixes and avoiding vague low-trust tasks.", de: "Workflow getestet, um echte Maintenance-Arbeit zu finden, Buyer-Signale zu prüfen, Fixes vorzubereiten und vage Low-Trust-Aufgaben zu vermeiden." },
        { selector: "#work .work-list article:nth-child(15) h3", en: "TraceTrust / Agent Marketplace", de: "TraceTrust / Agent Marketplace" },
        { selector: "#work .work-list article:nth-child(15) p", en: "Built a read-only public demo for a trust-first AI agent workflow: scoped tasks, execution evidence, reviewer decisions and payout evidence.", de: "Read-only-Public-Demo für einen trust-first AI-Agent-Workflow gebaut: klarer Scope, Ausführungsevidence, Reviewer-Entscheidungen und Payout Evidence." },
        { selector: "#work .work-list article:nth-child(16) h3", en: "Payment rails and pilot economics", de: "Payment Rails und Pilot Economics" },
        { selector: "#work .work-list article:nth-child(16) p", en: "Compared marketplace payment patterns and chose a EUR-first pilot path. The reason is simple: less friction, clearer accounting and better dispute handling for early validation.", de: "Marketplace-Payment-Muster verglichen und einen EUR-first-Pilotpfad gewählt. Der Grund ist simpel: weniger Reibung, klarere Buchhaltung und bessere Streitfallbehandlung für frühe Validierung." },
        { selector: "#work .work-list article:nth-child(17) h3", en: "OpenClaw browser threads spike", de: "OpenClaw Browser-Threads-Spike" },
        { selector: "#work .work-list article:nth-child(17) p", en: "Prototyped multi-conversation browser UX for an agent interface behind an experimental flag. Kept the live runtime untouched and verified behavior in an isolated browser test lane.", de: "Multi-Conversation-Browser-UX für ein Agent-Interface hinter einem Experimental Flag prototypisiert. Die Live-Runtime blieb unberührt; Verhalten wurde in einer isolierten Browser-Test-Lane geprüft." },
        { selector: "#work .work-list article:nth-child(18) h3", en: "OpenViking memory for agents", de: "OpenViking Memory für Agents" },
        { selector: "#work .work-list article:nth-child(18) p", en: "Set up local semantic memory for agent sessions with OpenViking and local embeddings, then added watchdog checks so search, recall and runtime health stay visible.", de: "Lokales semantisches Memory für Agent-Sessions mit OpenViking und lokalen Embeddings eingerichtet, plus Watchdog-Checks, damit Suche, Recall und Runtime-Health sichtbar bleiben." },
        { selector: "#work .work-list article:nth-child(19) h3", en: "Hermes / OpenClaw migration", de: "Hermes / OpenClaw Migration" },
        { selector: "#work .work-list article:nth-child(19) p", en: "Migrated useful OpenClaw routines into Hermes, cleaned up stale services and kept rollback notes. The focus was boring on purpose: preserve what works, remove what silently breaks.", de: "Nützliche OpenClaw-Routinen nach Hermes migriert, veraltete Services bereinigt und Rollback-Notizen behalten. Der Fokus war absichtlich unspektakulär: bewahren, was funktioniert, und entfernen, was leise bricht." },
        { selector: "#work .work-list article:nth-child(20) h3", en: "Matrix-based agent delivery", de: "Matrix-basierte Agent-Zustellung" },
        { selector: "#work .work-list article:nth-child(20) p", en: "Recovered Matrix delivery for local agent notifications, including self-signed TLS handling, room trust rules and smoke tests with real Matrix events.", de: "Matrix-Zustellung für lokale Agent-Benachrichtigungen wiederhergestellt, inklusive Self-signed-TLS-Handling, Room-Trust-Regeln und Smoke Tests mit echten Matrix-Events." },
