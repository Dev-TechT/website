(() => {
    ...
    const content = [
        ...
        { selector: ".main-navigation a[href='index.html#services']", en: "Background", de: "Profil" },
        { selector: ".main-navigation a[href='index.html#about']", en: "About Me", de: "Über mich" },
        { selector: ".main-navigation a[href='index.html#project']", en: "Current Project", de: "Aktuelles Projekt" },
        { selector: ".main-navigation a[href='index.html#work']", en: "Projects", de: "Projekte" },
